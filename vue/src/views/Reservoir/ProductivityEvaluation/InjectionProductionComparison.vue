...
<template>
  <div ref="workspaceEl" class="comparison-workspace">
    ...
    <main class="result-area">
      ...
      <PeriodWellChart3D comparison-type="direction" :result="comparisonResult" :busy="calculating" :title="resultTitle" :project-id="projectId" :gas-reservoir-id="gasReservoirId" :storage-id="storageId" />
    </main>
  </div>
</template>
