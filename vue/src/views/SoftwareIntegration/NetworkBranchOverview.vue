...
watch([search, missingOnly, pageSize], () => { currentPage.value = 1 })
...
<template>
  <section class="branch-overview" aria-label="管网支路工况总览">
    ...
    <el-table :data="pageRows" border size="small" max-height="300" empty-text="没有符合条件的支路工况">
...
.filters { margin-top: 10px; } .filters .el-input { width: 240px; } p { line-height: 1.6; margin: 8px 0; } .network-pagination { justify-content: flex-end; margin-top: 10px; }
</style>
