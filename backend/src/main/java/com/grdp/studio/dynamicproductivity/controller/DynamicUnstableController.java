...
import com.grdp.studio.dynamicproductivity.service.DynamicUnstableStorageService;
...
/** 动态产能不稳定流：后端计算与独立五表存储接口。 */
@RestController
@RequestMapping("/dynamic-productivity/unstable")
public class DynamicUnstableController {
    private final DynamicUnstableCalculationService calculationService;
    private final DynamicUnstableStorageService storageService;

    public DynamicUnstableController(DynamicUnstableCalculationService calculationService,
                                     DynamicUnstableStorageService storageService) {
