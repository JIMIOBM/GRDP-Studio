...
import com.grdp.studio.dynamicproductivity.service.DynamicStableStorageService;
...
/** 动态产能稳定流的新库读写接口；计算本身仍复用原平台算法接口。 */
@RestController
@RequestMapping("/dynamic-productivity/stable")
public class DynamicStableController {
    private final DynamicStableStorageService storageService;

    public DynamicStableController(DynamicStableStorageService storageService) {
